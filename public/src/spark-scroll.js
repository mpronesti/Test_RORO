(function() {
  ...
  angular.module('gilbox.sparkScroll', []).factory('sparkAnimator', [
    ...
    topTop: function topTop(element, container, rect, containerRect, offset) {console.log(rect.top + "/" + containerRect.top + "/" + offset +"/" + (rect.top - containerRect.top + offset)); return ~~(rect.top - containerRect.top + offset) },
    topCenter: function topCenter(element, container, rect, containerRect, offset) {console.log(container); console.log("center"+rect.top + "/ /" + containerRect.top+"/ /" + (rect.top - containerRect.top - container.clientHeight/2 + offset) + "~~"+ container.clientHeight); return ~~(rect.top - containerRect.top - container.clientHeight/2 + offset) },
